 ...
 */
export default function addDuplicateRow(tr, { map, tableStart, table }, row, withContent = true) {
    var _a;
    ...
    for (let col = 0, index = map.width * row; col < map.width; col++, index++) {
        ...
        if (row > 0 &&
            ...
            tr.setNodeMarkup(tableStart + pos, null, Object.assign(Object.assign({}, attrs), { rowspan: attrs.rowspan + 1 }));
            ...
            const type = refRow == null
                ...
                : (_a = table.nodeAt(map.map[index + refRow * map.width])) === null || _a === void 0 ? void 0 : _a.type;
            // Create a new cell node, optionally copying content
            const node = _refRow !== null
                ? (withContent
                    ? type === null || type === void 0 ? void 0 : type.create(Object.assign({}, _refRow.attrs), _refRow.content)
                    : type === null || type === void 0 ? void 0 : type.createAndFill(Object.assign({}, _refRow.attrs)))
                : type === null || type === void 0 ? void 0 : type.createAndFill();
