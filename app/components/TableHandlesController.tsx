...
export const TableHandlesController: FC<TableHandlesControllerProps> = ({ editor }) => {
    ...
    const { addOrRemoveRowsButton, addOrRemoveColumnsButton } = useExtendButtonsPositioning(
